...
/**
 * Collapsible SEO section shared by the Product admin form.
        ...
        <div className="space-y-4 border-t border-[var(--color-border)] bg-white px-5 py-5">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <p className="text-xs text-[var(--color-muted)]">
              Laissez vide pour générer automatiquement à partir du nom, de la description et de la photo
              principale de cet(te) {entityLabel}.
            </p>
            {onAutoFill && (
              <button
                type="button"
                onClick={onAutoFill}
                title={`Générer le titre, la description et les mots-clés à partir des informations de cet(te) ${entityLabel}`}
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-[var(--color-muted)]">Titre SEO</label>
            <input
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-[var(--color-muted)]">Description SEO</label>
            <textarea
              rows={2}
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-[var(--color-muted)]">Mots-clés</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-[var(--color-muted)]">
              Image de partage social (remplacement optionnel)
            </label>
              ...
              <div className="flex min-w-0 flex-1 gap-2">
                ...
                {onUploadImage && (
                  <>
                    ...
                    <label
                      htmlFor={fileInputId}
                      title="Téléverser depuis l'appareil"
                ...
                {onSelectExisting && (
                  <button
                    ...
                    title="Choisir parmi les images déjà téléversées"
            ...
            <p className="text-xs text-[var(--color-muted)]">
              Remplace la photo principale lorsqu'elle est laissée vide.
            </p>
          </div>
        </div>
      )}
